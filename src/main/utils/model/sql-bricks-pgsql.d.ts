...
declare namespace SqlBricksPgsql {
  /**
  ...
  interface InsertStatement extends Statement {
    ...
    onConflict(...columns: string[]): InsertStatement;
    doNothing(): InsertStatement;
    doUpdate(cols?: string[] | true): InsertStatement;
  }
  ...
  interface UpdateStatement extends Statement {
    ...
    from(...tables: string[]): UpdateStatement;
  }
  ...
  interface DeleteStatement extends Statement {
    ...
    returning(...columns: string[]): DeleteStatement;
    using(...tables: string[]): DeleteStatement;
  }

  interface ValuesStatement extends Statement {
    as(alias: string): ValuesStatement;
    columns(): ValuesStatement;
    types(types?: true | { [field: string]: string }): ValuesStatement;
  }
}
...
interface SqlBricksFn {
   ...
   */
  insert(tbl?: string, ...values: any[]): SqlBricksPgsql.InsertStatement
   ...
   * // INSERT INTO person (first_name, last_name) VALUES ('Fred', 'Flintstone')
   */
  insertInto(tbl?: string, ...values: any[]): SqlBricksPgsql.InsertStatement
   ...
   */
  select(...columns: Array<string | SqlBricksPgsql.SelectStatement>): SqlBricksPgsql.SelectStatement
  select(columns: string[] | SqlBricksPgsql.SelectStatement[]): SqlBricksPgsql.SelectStatement
   ...
   * @param values
   */
  update(tbl: string, ...values: any[]): SqlBricksPgsql.UpdateStatement
   ...
   * @param tbl table name
   */
  delete(tbl?: string): SqlBricksPgsql.DeleteStatement
  /**
   * Returns a new DELETE statement. It can be used with or without the new operator.
   * @alias delete
   * @param tbl table name
   */
  deleteFrom(tbl?: string): SqlBricksPgsql.DeleteStatement
   ...
   * @param func
   */
  joinCriteria(func?: (...args: any[]) => SqlBricksPgsql.OnCriteria): any
   ...
   * @param whereExprs
   */
  and(...whereExprs: SqlBricksPgsql.WhereExpression[]): SqlBricksPgsql.WhereGroup

  /**
   * Joins the passed expressions with OR:
   * @param whereExprs
   */
  or(...whereExprs: SqlBricksPgsql.WhereExpression[]): SqlBricksPgsql.WhereGroup
   ...
   * @param whereExpr
   */
  not(whereExpr: SqlBricksPgsql.WhereExpression): SqlBricksPgsql.WhereGroup
   ...
   * @param value2
   */
  between(column: string, value1: any, value2: any): SqlBricksPgsql.WhereExpression
  isNull(column: string): SqlBricksPgsql.WhereExpression
  isNotNull(column: string): SqlBricksPgsql.WhereExpression
  like(column: string, value: any, escapeStr?: string): SqlBricksPgsql.WhereExpression
  exists(stmt: any): SqlBricksPgsql.WhereExpression
  in(column: string, stmt: SqlBricksPgsql.SelectStatement): SqlBricksPgsql.WhereExpression
  in(column: string, ...values: any[]): SqlBricksPgsql.WhereExpression
   ...
   */
  eq(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  equal(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  notEq(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  lt(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  lte(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  gt(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  gte(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary

  eqAll(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  notEqAll(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  ltAll(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  lteAll(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  gtAll(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  gteAll(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary

  eqAny(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  notEqAny(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  ltAny(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  lteAny(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  gtAny(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  gteAny(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary

  eqSome(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  notEqSome(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  ltSome(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  lteSome(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  gtSome(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  gteSome(column: string | SqlBricksPgsql.SelectStatement, value?: any): SqlBricksPgsql.WhereBinary
  ilike(column: string, value: any, escapeChar?: string): WhereExpression;
  values(_values: any[] | any): SqlBricksPgsql.ValuesStatement;
}

declare const SqlBricksPgsql: SqlBricksFn
export = SqlBricksPgsql
