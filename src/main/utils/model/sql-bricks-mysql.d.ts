...
declare namespace SqlBricksMysql {
  /**
  ...
  interface SelectStatement extends Statement {
    ...
    /**
     * MySQL extension: Sets the LIMIT clause for SELECT statements.
     * @param val the limit value
     */
    limit(val: number): SelectStatement

    /**
     * MySQL extension: Sets the OFFSET clause for SELECT statements.
  ...
  interface InsertStatement extends Statement {
    ...
    /**
     * MySQL extension: Adds ON DUPLICATE KEY UPDATE clause for upsert operations.
     * Can accept column names as strings or column-value pairs as objects.
     * @param cols array of column names or column-value objects
     * @example
     * insert('users', {name: 'John', email: 'john@example.com'})
     *   .onDuplicateKeyUpdate(['name', 'email'])
     *   .values(['John', 'john@example.com']);
     * // INSERT INTO users (name, email) VALUES ('John', 'john@example.com') ON DUPLICATE KEY UPDATE name = VALUES(name), email = VALUES(email)
     *
     * @example
     * insert('users', {name: 'John', email: 'john@example.com'})
     *   .onDuplicateKeyUpdate([{name: 'Jane'}, {email: sql.val('jane@example.com')}])
     *   .values(['John', 'john@example.com']);
     * // INSERT INTO users (name, email) VALUES ('John', 'john@example.com') ON DUPLICATE KEY UPDATE name = 'Jane', email = ?
     */
    onDuplicateKeyUpdate(cols: Array<string | { [key: string]: any }>): InsertStatement

    /**
     * MySQL extension: Adds IGNORE keyword to INSERT statement.
     * Silently ignores duplicate key errors.
     * @example
     * insert('users', {name: 'John'}).ignore().values(['John']);
  ...
  interface DeleteStatement extends Statement {
    ...
    /**
     * MySQL extension: Adds ORDER BY clause to DELETE statements.
     * @param columns can be passed as multiple arguments, a comma-delimited string or an array.
     */
    ...
    /**
     * MySQL extension: Adds LIMIT clause to DELETE statements.
     * @param val the limit value
     */
...
interface SqlBricksFn {
   ...
   */
  insert(tbl?: string, ...values: any[]): SqlBricksMysql.InsertStatement
   ...
   * // INSERT INTO person (first_name, last_name) VALUES ('Fred', 'Flintstone')
   */
  insertInto(tbl?: string, ...values: any[]): SqlBricksMysql.InsertStatement
   ...
   */
  select(...columns: Array<string | SqlBricksMysql.SelectStatement>): SqlBricksMysql.SelectStatement
  select(columns: string[] | SqlBricksMysql.SelectStatement[]): SqlBricksMysql.SelectStatement
   ...
   * @param values
   */
  update(tbl: string, ...values: any[]): SqlBricksMysql.UpdateStatement
   ...
   * @param tbl table name
   */
  delete(tbl?: string): SqlBricksMysql.DeleteStatement
  /**
   * Returns a new DELETE statement. It can be used with or without the new operator.
   * @alias delete
   * @param tbl table name
   */
  deleteFrom(tbl?: string): SqlBricksMysql.DeleteStatement
   ...
   * @param func
   */
  joinCriteria(func?: (...args: any[]) => SqlBricksMysql.OnCriteria): any
   ...
   * @param whereExprs
   */
  and(...whereExprs: SqlBricksMysql.WhereExpression[]): SqlBricksMysql.WhereGroup

  /**
   * Joins the passed expressions with OR:
   * @param whereExprs
   */
  or(...whereExprs: SqlBricksMysql.WhereExpression[]): SqlBricksMysql.WhereGroup
   ...
   * @param whereExpr
   */
  not(whereExpr: SqlBricksMysql.WhereExpression): SqlBricksMysql.WhereGroup
   ...
   * @param value2
   */
  between(column: string, value1: any, value2: any): SqlBricksMysql.WhereExpression
  isNull(column: string): SqlBricksMysql.WhereExpression
  isNotNull(column: string): SqlBricksMysql.WhereExpression
  like(column: string, value: any, escapeStr?: string): SqlBricksMysql.WhereExpression
  exists(stmt: any): SqlBricksMysql.WhereExpression
  in(column: string, stmt: SqlBricksMysql.SelectStatement): SqlBricksMysql.WhereExpression
  in(column: string, ...values: any[]): SqlBricksMysql.WhereExpression
   ...
   */
  eq(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  equal(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  notEq(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  lt(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  lte(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  gt(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  gte(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary

  eqAll(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  notEqAll(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  ltAll(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  lteAll(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  gtAll(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  gteAll(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary

  eqAny(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  notEqAny(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  ltAny(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  lteAny(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  gtAny(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  gteAny(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary

  eqSome(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  notEqSome(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  ltSome(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  lteSome(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  gtSome(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
  gteSome(column: string | SqlBricksMysql.SelectStatement, value?: any): SqlBricksMysql.WhereBinary
}

declare const SqlBricksMysql: SqlBricksFn
export = SqlBricksMysql
