...
declare namespace SqlBricksSqlite {
  /**
  ...
  interface SelectStatement extends Statement {
    ...
    limit(val: number | string): SelectStatement;
    offset(val: number | string): SelectStatement;
  }
  ...
  interface InsertStatement extends Statement {
    ...
    orRollback(): InsertStatement;
    orAbort(): InsertStatement;
    orFail(): InsertStatement;
  }
...
interface SqlBricksSqliteInstance {
  (...params: any[]): any
  /**
   ...
   */
  insert(tbl?: string, ...values: any[]): SqlBricksSqlite.InsertStatement
   ...
   * // INSERT INTO person (first_name, last_name) VALUES ('Fred', 'Flintstone')
   */
  insertInto(tbl?: string, ...values: any[]): SqlBricksSqlite.InsertStatement
   ...
   */
  select(...columns: Array<string | SqlBricksSqlite.SelectStatement>): SqlBricksSqlite.SelectStatement
  select(columns: string[] | SqlBricksSqlite.SelectStatement[]): SqlBricksSqlite.SelectStatement
   ...
   * @param values
   */
  update(tbl: string, ...values: any[]): SqlBricksSqlite.UpdateStatement
   ...
   * @param tbl table name
   */
  delete(tbl?: string): SqlBricksSqlite.DeleteStatement
  /**
   * Returns a new DELETE statement. It can be used with or without the new operator.
   * @alias delete
   * @param tbl table name
   */
  deleteFrom(tbl?: string): SqlBricksSqlite.DeleteStatement
   ...
   * @param func
   */
  joinCriteria(func?: (...args: any[]) => SqlBricksSqlite.OnCriteria): any
   ...
   * @param whereExprs
   */
  and(...whereExprs: SqlBricksSqlite.WhereExpression[]): SqlBricksSqlite.WhereGroup

  /**
   * Joins the passed expressions with OR:
   * @param whereExprs
   */
  or(...whereExprs: SqlBricksSqlite.WhereExpression[]): SqlBricksSqlite.WhereGroup
   ...
   * @param whereExpr
   */
  not(whereExpr: SqlBricksSqlite.WhereExpression): SqlBricksSqlite.WhereGroup
   ...
   * @param value2
   */
  between(column: string, value1: any, value2: any): SqlBricksSqlite.WhereExpression
  isNull(column: string): SqlBricksSqlite.WhereExpression
  isNotNull(column: string): SqlBricksSqlite.WhereExpression
  like(column: string, value: any, escapeStr?: string): SqlBricksSqlite.WhereExpression
  exists(stmt: any): SqlBricksSqlite.WhereExpression
  in(column: string, stmt: SqlBricksSqlite.SelectStatement): SqlBricksSqlite.WhereExpression
  in(column: string, ...values: any[]): SqlBricksSqlite.WhereExpression
   ...
   */
  eq(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  equal(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  notEq(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  lt(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  lte(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  gt(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  gte(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary

  eqAll(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  notEqAll(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  ltAll(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  lteAll(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  gtAll(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  gteAll(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary

  eqAny(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  notEqAny(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  ltAny(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  lteAny(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  gtAny(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  gteAny(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary

  eqSome(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  notEqSome(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  ltSome(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  lteSome(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  gtSome(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
  gteSome(column: string | SqlBricksSqlite.SelectStatement, value?: any): SqlBricksSqlite.WhereBinary
}

// 4. 导出最终的实体
declare const SqlBricksSqlite: SqlBricksSqliteInstance;
export default SqlBricksSqlite;